  ...
  if(test_status(receive_in_progress)) 
  {
	...
	else 
	{
	  ...
	  {							// any other bit, results?
	    ...
	    case 2: set_status(receive_noise_error);	// noise in middle samples, "1" received
#ifdef PARITY
	    case 3:	if(Rx_bit < DATA_LENGTH)  
